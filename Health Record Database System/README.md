...
- History of Present Illness (HPI): timeline, severity, and symptoms
- Physical Examination Findings: Vital signs: blood pressure, heart rate, temperature, and oxygen saturation
- Diagnosis: provisional (suspected) or confirmed condition
- Orders: Requests for laboratory tests or radiology images
- Prescriptions: Medications prescribed to the patient
- Recommendations: like life style advice, next visit date, etc 
