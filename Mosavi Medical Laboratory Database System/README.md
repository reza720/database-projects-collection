## Scenario
### Mosavi Medical Laboratory Database System
...
Technicians: manage information about lab technicians who perform tests and record results
- Test Orders: track where each test request originates from
- Patients: store and manage patient information
- Tests: maintain a catalog of available laboratory tests
- Test Results: record and manage results of performed tests
- Payments: handle payments related to laboratory tests
- Test Approvals: manage verification and approval of test results by supervisors
